...
# with open('model/'+model+'_2_conv.pkl','r') as f:
# # with open('model/'+model+'_conv.pkl','r') as f:
# 	data = pkl.load(f)
...
# 	with open('model/'+model+'_'+str(i)+'_2_retrained_cipytonv.pkl','r') as f:
# 		data = pkl.load(f)
...
# with open('model/'+model+'_'+'95'+'_2_retrained_conv.pkl','r') as f:
# 	data = pkl.load(f)
